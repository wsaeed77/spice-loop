...
export default function DeliveryRiderEdit({ auth, rider, flash }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        patch(`/admin/riders/${rider.id}`);
    };

    return (
        <Layout auth={auth}>
            <Head title="Edit Delivery Rider - SpiceLoop" />
            
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="mb-8">
                    <h1 className="text-4xl font-bold text-spice-maroon mb-2">Edit Delivery Rider</h1>
                    <Link
                        href="/admin/riders"
                ...
                <div className="bg-white rounded-lg shadow-md p-8 border border-spice-orange">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex justify-end space-x-4 pt-4">
                            ...
                            >
                                {processing ? 'Updating...' : 'Update Rider'}
                            </button>
                        </div>
                    </form>
                </div>
